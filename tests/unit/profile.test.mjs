...
function setup(stored = {}){
  ...
  const w = load('assets/js/profile.js', { localStorage, document, addEventListener(){} });
...
test('blocked storage (e.g. private mode) falls back quietly', () => {
  ...
  const w = load('assets/js/profile.js', { localStorage: broken, document: fakeDocument(), addEventListener(){} });
